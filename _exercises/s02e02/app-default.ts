...
const IMAGE_PATH = join(__dirname, 's02e02_tmp.png');
const OPTIMIZED_IMAGE_PATH = join(__dirname, 's02e02_tmp_optimized.png');
...
(async () => {
    try {
        ...
        const messages: ChatCompletionMessageParam[] = [
            {
                role: "system",
                content: "Jesteś pomocnym asystentem, który potrafi odpowiadać na pytania i pomagać w wykonywaniu zadań."
            },
            {
                role: "user",
                content: [
                    ...
                    {
                        type: "text",
                        text: "Pomóż mi rozwiązać zagadkę z tego obrazka. Być może liczby lub symbole widoczne na nim reprezentują nazwę miasta. Przeanalizuj obraz i podpowiedz, jakie miasto może być z nim związane."
                    },
                ]
            }
        ];
